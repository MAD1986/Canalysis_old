...
Spatial_correlation.options.sessions=1:3; % X:Y compare session X to Y
...
Spatial_correlation.options.onlytuned=[1 3];
...
Spatial_correlation.options.sessions=1:3; %sessions to compare -all
Spatial_correlation.options.STDsessions=[1 ]; %STD sessions to analyse 
Spatial_correlation.options.MISsessions=[2]; %STD sessions to analyse 

%PV and TC correlation for all bins vs only shifted bins / non shifted bins
[Spatial_correlation] = corr_shift_texture(Spatial_correlation, MIS, plot_sessions);
