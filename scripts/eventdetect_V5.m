...
function [Events]=eventdetect_V4(Events, Imaging);
...
for i=1:size(C_df,2);
    ...
    [events_time_1{i},time_1]=Threshold([stamps_1' subdata_1],'>=',SDON*std_dev_1(i),'min', mindur, 'max',mergdur);
...
[onset_offset_1] = onoff_V3(events_time_1, C_df, offset_1);
...
[events_time_2{i},time_2]=Threshold([stamps_1' subdata_1],'>=',SDON*std_dev_noevents_1(i),'min', mindur, 'max',mergdur);
...
offset_2{i}=stop_2; 
[onset_offset_2] = onoff_V3(events_time_2, C_df, offset_2);
%Make binary for onset /i=ROI analyse
...
[events_time_3{i},time_3]=Threshold([stamps_1' subdata_1],'>=',SDON*std_dev_noevents_2(i),'min', mindur, 'max',mergdur);
...
offset_3{i}=stop_3; 
[onset_offset_3] = onoff_V3(events_time_3, C_df, offset_3);
%Make binary for onset /i=ROI analyse
...
while eventduration{i}(ii)<mindurevent,
...
PlotHVLines(SDOFF*std_dev_noevents_2(1,c2plot),'h', 'r');
%plot(onset_binary_1(:,i));
%plot(onset_binary_2(:,i));
plot(onset_binary(:,c2plot));
%plot(onset_offset_ones_3(:,i));
